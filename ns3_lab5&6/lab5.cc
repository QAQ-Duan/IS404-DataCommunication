...
main (int argc, char *argv[])
{
  ...
  Ptr<OutputStreamWrapper> stream1 = asciiTraceHelper.CreateFileStream ("sixth1.cwnd");
  devices.Get (1)->TraceConnectWithoutContext ("PhyRxDrop", MakeBoundCallback (&RxDrop, stream1));
  
  Ptr<OutputStreamWrapper> stream2 = asciiTraceHelper.CreateFileStream ("sixth2.cwnd");
  devices.Get (1)->TraceConnectWithoutContext ("PhyRxEnd", MakeBoundCallback (&RxEnd, stream2));
